...
export default function App() {
  ...
  const addCategory = async () => {
    ...
    const availableColor =
      colorKeysAvailable.find((c) => !usedColors.includes(c)) || "blue";
    const randomEmoji =
  ...
  const filteredItems = items.filter((item) => {
    ...
    const priorityMatch =
      filterPriority === "すべて" || item.priority === filterPriority;
  ...
  return (
    ...
    >
      ...
      <div className="max-w-md mx-auto">
        ...
        {currentPage === "checklist" && (
          <>
            <header className="text-center mb-6">
              ...
              {!isDueDateEditing ? (
                <button
                  ...
                  className={`inline-block mt-2 mb-2 px-4 py-2 rounded-xl transition-all ${
                    darkMode
                ...
                <div
                  className={`mt-2 mb-2 p-3 rounded-xl shadow-sm ${
                    darkMode ? "bg-gray-800" : "bg-white"
                  }`}
                >
              ...
              <p
                className={`text-sm flex items-center justify-center gap-1 ${textMuted}`}
              >
              ...
              <div
                className={`mt-2 inline-flex items-center gap-1 text-xs px-3 py-1 rounded-full ${
                  darkMode
            ...
            {items.length === 0 && categories.length === 0 && (
              <div
                className={`rounded-2xl shadow-sm p-5 mb-5 border text-center ${cardClass}`}
              >
            ...
            {items.length > 0 && (
              <div
                className={`rounded-2xl shadow-sm p-5 mb-5 border ${cardClass}`}
              >
                <div className="flex items-center justify-between mb-3">
                  <span
                    className={`text-sm font-semibold flex items-center gap-1 ${textSecondary}`}
                  >
            ...
            {items.length > 0 && (
              <div
                className={`rounded-2xl shadow-sm p-4 mb-5 border ${cardClass}`}
              >
                <h2
                  className={`text-sm font-semibold mb-3 flex items-center gap-1 ${textSecondary}`}
                >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <select
                    ...
                    className={`px-3 py-2 border rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-200 ${
                      darkMode
            ...
            {categories.map((category) => {
              ...
              const catCheckedCount = allCategoryItems.filter(
                (i) => i.checked
              ).length;
              ...
              const catProgress =
                catTotalCount === 0
                  ? 0
                  : Math.round((catCheckedCount / catTotalCount) * 100);

              return (
                <div key={category.id} className="mb-5">
                  <div className="flex items-center justify-between mb-2 px-2">
                    <h2
                      className={`text-sm font-bold flex items-center gap-2 ${style.text}`}
                    >
                      ...
                      >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-1 flex-wrap">
                              ...
                              {item.checked && item.checkedBy && (
                                <span
                                  className={`inline-flex items-center gap-0.5 text-xs ${textMuted}`}
                                >
                                  <Check className="w-3 h-3" />
                                  {getUserEmoji(item.checkedBy)}{" "}
                                  {item.checkedBy} が完了
                                </span>
                              )}
                              {item.price && (
                        ...
                        {editingItemId === item.id && (
                          ...
                          >
                            <div>
                              <label
                                className={`text-xs block mb-1 ${textMuted}`}
                              >
                                💰 値段(円)
                              </label>
                              <input
                            ...
                            <div>
                              ...
                              <select
                                ...
                                className={`w-full px-3 py-1.5 border rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-pink-200 ${
                                  darkMode
                                    ? "bg-gray-700 border-gray-600 text-gray-100"
                                    : "bg-white border-gray-200"
                                }`}
            ...
            {isFiltering && filteredItems.length === 0 && (
              <div
                className={`rounded-2xl shadow-sm p-6 mb-5 border text-center ${cardClass}`}
              >
            ...
            {progress === 100 && totalCount > 0 && (
              <div
                className={`rounded-2xl p-5 text-center border mt-4 ${
                  darkMode
                    ? "bg-gradient-to-r from-pink-900/40 to-purple-900/40 border-pink-700"
        ...
        {currentPage === "diaper" && (
          <DiaperLog currentUser={currentUser} darkMode={darkMode} />
        )}
...
<nav className={`fixed bottom-0 left-0 right-0 border-t shadow-lg z-50 ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}>
        <div className="grid grid-cols-3 max-w-md mx-auto">
          ...
          <button
            ...
            className={`py-3 px-2 flex flex-col items-center gap-0.5 transition-all ${
              currentPage === "diaper"
                ? darkMode
          ...
          <button
            ...
            className={`py-3 px-2 flex flex-col items-center gap-0.5 transition-all rounded-r-full ${
              currentPage === "contacts"
                ? darkMode
                  ? "text-rose-400 bg-gray-700"
