...
export default function EmergencyContacts({ darkMode }) {
  ...
  return (
    <div className="max-w-md mx-auto">
        ...
        {!isAdding ? (
          ...
          <div>
            ...
            <input
              ...
              placeholder="例:○○産婦人科"
              className={`w-full px-3 py-2 border rounded-lg mb-2 text-base focus:outline-none focus:ring-2 focus:ring-rose-200 ${
                darkMode
            ...
            <select
              ...
              className={`w-full px-3 py-2 border rounded-lg mb-3 text-base focus:outline-none focus:ring-2 focus:ring-rose-200 ${
                darkMode
                  ? "bg-gray-700 border-gray-600 text-gray-100"
      ...
      {contacts.length === 0 ? (
        <div
          className={`rounded-2xl shadow-sm p-8 text-center border ${
            darkMode
        ...
        <div className="space-y-2 mb-32">
          {contacts.map((contact) => {
            const style =
              categoryStyles[contact.category] || categoryStyles["その他"];
                  ...
                  <div className="space-y-2 mb-3">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 py-2 border rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-purple-200 ${
                          darkMode
                            ? "bg-gray-700 border-gray-600 text-gray-100"
                            : "border-gray-200"
                        }`}
            ...
            return (
              <div
                ...
                className={`rounded-xl border ${style.bg} ${
                  ...
                  isMenuOpen ? "ring-2 ring-purple-300" : ""
                }`}
              >
                {/* カード本体 */}
                <div className="p-3">
                ...
                {isMenuOpen && (
                  <div
                    className={`grid grid-cols-3 gap-1 p-2 border-t ${
                      darkMode
                  ...
                  >
                    ...
                    <button
                      ...
                      className={`flex flex-col items-center justify-center gap-1 py-2 rounded-lg text-xs font-semibold transition-all active:scale-95 ${
                        darkMode
